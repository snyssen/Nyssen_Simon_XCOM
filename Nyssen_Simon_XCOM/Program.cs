        ...
        static void Main()
        {
            ...
            do
            {
                ...
                if (accueil.GameLaunch) // On veut lancer/reprendre une partie
                {
                    ...
                    {
                        game = new EcranGame(accueil.AudioOn, accueil.setup.SelectedbtnIndex, accueil.setup.NbrFantassins, accueil.setup.NbrSnipers, accueil.setup.NbrLourds, accueil.setup.NbrLegers);
                        Application.Run(game);
                    }
                    else // On reprend une partie précédente
                    {
                        game = new EcranGame(accueil.AudioOn, accueil.SelectedbtnIndex, accueil.Joueur1Joue,
